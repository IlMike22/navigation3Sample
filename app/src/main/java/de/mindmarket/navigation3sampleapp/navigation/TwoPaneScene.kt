...
/**
 * Define here how the content is aligned in the scene.
 */
        ...
        get() = {
            Row(
                ...
                Box(
                    ...
                    secondEntry.content(firstEntry.key)
                }
            }
        }
    ...
    override fun calculateScene(
        ...
        return if (lastTwoEntries.size == 2 && hasTwoPaneKey) {
            ...
            TwoPaneScene(
                ...
                previousEntries = entries.dropLast(1), // define where to go when navigating back
